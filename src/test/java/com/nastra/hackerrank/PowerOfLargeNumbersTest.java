...
//        Assert.assertEquals(PowerOfLargeNumbers.power(new BigInteger("34534985349875439875439875349875"), new BigInteger("93475349759384754395743975349573495")), new BigInteger("735851262"));
//        Assert.assertEquals(PowerOfLargeNumbers.powerIterative(new BigInteger("34534985349875439875439875349875"), new BigInteger("93475349759384754395743975349573495")), new BigInteger("735851262"));
//        Assert.assertEquals(PowerOfLargeNumbers.power(new BigInteger("34543987529435983745230948023948"), new BigInteger("3498573497543987543985743989120393097595572309482304")), new BigInteger("985546465"));
//        Assert.assertEquals(PowerOfLargeNumbers.powerIterative(new BigInteger("34543987529435983745230948023948"), new BigInteger("3498573497543987543985743989120393097595572309482304")), new BigInteger("985546465"));
