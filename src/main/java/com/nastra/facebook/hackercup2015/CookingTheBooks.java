...
/**
 * @see https
 *      ://www.facebook.com/hackercup/problems.php?pid=582062045257424&round
 *      =742632349177460
 * @author nastra
 * 
 */
public class CookingTheBooks {
	...
	static class PermuterA {
		...
		public static List<String> permute(String input) {
			...
			List<String> perms = generatePermutations(first, words,
					permutations);
			return perms;
		}

		private static List<String> generatePermutations(char first,
				List<String> words, List<String> permutations) {
