 ...
 * difference of K. [K>0 and K< 1e9]. Each of the N integers will be greater
 * than 0 and at least K away from 2^31-1 (Everything can be done with 32 bit
 * integers).
 * 
 * Input Format
 * 
 ...
 * Output Format
 * 
 * One integer saying the number of pairs of numbers that have a diff K. @author
 * nastra
 */
public class Pairs {
