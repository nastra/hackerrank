...
/**
 * You and your K-1 friends want to buy N flowers. Flower number i has minCosts
 * ci. Unfortunately the seller does not like a customer to buy a lot of
 * flowers, so he tries to change the price of flowers for customer who had
 * bought flowers before. More precisely if a customer has already bought x
 * flowers, he should pay (x+1)*ci dollars to buy flower number i. You and your
 * K-1 friends want to buy all N flowers in such a way that you spend the least
 ...
 * to buy all N flowers. @author nastra - Eduard Tudenhoefner
 */
public class Flowers {

	public static int minCosts(Integer[] flowerCosts, int[] personsPurchase,
			int[] buys) {
		int sum = 0;
