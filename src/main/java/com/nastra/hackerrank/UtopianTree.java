 ...
 * meter. If a new Utopian tree sampling of height 1 meter is planted just
 * before the onset of the monsoon season, can you find the height of the tree
 * after N cycles?
 * 
 * Input Format The first line of the input contains an integer T, the number of
 * testcases. T lines follow each line containing the integer N, indicating the
 * number of cycles.
 * 
